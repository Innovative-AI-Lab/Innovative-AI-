  ...
  return (
    <div className="relative">
      ...
      >
        {/* Icon */}
        <div
          className={`pl-4 pr-0 flex-shrink-0 transition-colors duration-200 ${focused ? "text-violet-500" : "text-gray-350"}`}
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Gradient orbs */}
          <div
            className="orb1 absolute top-[-80px] left-[-60px] w-[420px] h-[420px] rounded-full pointer-events-none"
            style={{
              background:
          ...
          />
          <div
            className="orb2 absolute bottom-[-100px] right-[-80px] w-[500px] h-[500px] rounded-full pointer-events-none"
            style={{
              background:
            ...
            >
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17H3a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v2M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2h-2"
                />
              </svg>
            </div>
          ...
          <div className="relative flex-1 flex flex-col justify-center py-16">
            ...
            >
              ...
              <h1 className="playfair text-5xl font-bold text-white leading-[1.15] mb-6">
                Build faster
                <br />
                with <span style={{ color: "#a78bfa" }}>AI</span> by
                <br />
                your side.
              </h1>
              <p className="text-white/45 text-sm leading-relaxed max-w-xs">
                A collaborative workspace where teams ship production-ready
          ...
          >
            <div className="flex -space-x-2">
              {["#7c3aed", "#4f46e5", "#0891b2", "#059669", "#d97706"].map(
                (c, i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full border-2 flex items-center justify-center text-white text-[11px] font-bold"
        ...
        <div className="flex-1 flex flex-col min-h-screen">
          ...
          <div className="flex-1 flex items-center justify-center px-6 py-12">
            ...
            >
              {/* Heading */}
              <div className="mb-8">
                <h2 className="playfair text-3xl font-bold text-gray-900 mb-2">
                  Sign in
                </h2>
          ...
          <div className="px-6 pb-6 text-center">
            <p className="text-xs text-gray-400">
              ...
              <span className="ml-1 hover:text-gray-600 cursor-pointer transition-colors">
                Privacy
              </span>{" "}
              ·
              <span className="ml-1 hover:text-gray-600 cursor-pointer transition-colors">
