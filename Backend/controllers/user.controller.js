...
export const logoutController = async (req, res) => {
  try {
    ...
    return errorResponse(res, "Logout failed", 400, err);
  }
};
...
export const getAllUsersController = async (req, res) => {
  try {
    ...
    return successResponse(res, { users: allUsers }, "Users fetched successfully");
  } catch (err) {
...
export const createUserByAdminController = async (req, res) => {
  try {
    ...
    const userObj = user.toObject();
    delete userObj.password;
    return successResponse(res, { user: userObj }, "User created by admin", 201);
  } catch (error) {
    return errorResponse(res, error.message, 400, error);
  }
};
...
export const updateUserByAdminController = async (req, res) => {
  try {
    ...
    const userObj = updatedUser.toObject();
    delete userObj.password;
    return successResponse(res, { user: userObj }, "User updated by admin");
  } catch (error) {
    return errorResponse(res, error.message, 400, error);
  }
};
